...
import { UnpackedPostTagDTO } from "@caffeine-packages/post.post-tag/domain/dtos";
import { UnpackedPostTypeDTO } from "@caffeine-packages/post.post-type/domain/dtos";
        ...
        t.Object(
            {
                ...
                cover: t.String({
                    description:
                        "The URL or path to the cover image of the post.",
            ...
            {
                description:
                    "Data transfer object used for building a post entity.",
            },
        ),
        EntityDTO,
    ],
